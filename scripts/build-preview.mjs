...
function page(appHtml, stamp) {
  ...
  return `<title>BodyEvolve on a Phone</title>
<meta name="description" content="The BodyEvolve tracker running live in an iPhone chassis.">
...
<main>
  <div class="rig" id="rig">
    <div class="phone">
      <div class="screen"><iframe id="app" title="BodyEvolve running in a phone-sized viewport"></iframe></div>
