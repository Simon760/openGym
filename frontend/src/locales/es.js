...
export default {
  ...
  "This browser doesn't support passkeys — you can still use BodyTransformation locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar BodyTransformation localmente en este dispositivo.',
  ...
  'to install BodyTransformation as a full-screen app.': 'para instalar BodyTransformation como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if BodyTransformation is closed.': 'Avisos del temporizador de descanso, incluso con BodyTransformation cerrado.',
  ...
  'A small file a friend imports into their own BodyTransformation — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio BodyTransformation: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'this isn’t an BodyTransformation plan file': 'esto no es un archivo de plan de BodyTransformation',
  ...
  'Reload BodyTransformation': 'Recargar BodyTransformation',
