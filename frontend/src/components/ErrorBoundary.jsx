...
export default class ErrorBoundary extends Component {
  ...
  componentDidCatch(err) { console.error('BodyTransformation render error:', err) }
  ...
  render() {
    ...
    return (
      <div className="narrow">
        ...
        <Button variant="primary" icon="reset" onClick={() => location.reload()}>{t('Reload BodyTransformation')}</Button>
        {active && <>
          <div style={{ height: 8 }} />
